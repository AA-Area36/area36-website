...
import { generateOccurrenceDates, getRecurrenceDescription, parseLocalDate, formatDate } from "@/lib/utils/recurrence"
                ...
                >
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1 text-sm text-muted-foreground">
                      ...
                      <span>
                        {formatTimeRange(
                          occurrence.isModified && occurrence.exception?.startTime
                            ? occurrence.exception.startTime
                            : event.startTime,
                          occurrence.isModified && occurrence.exception?.endTime
                            ? occurrence.exception.endTime
                            : event.endTime,
                          event.timezone
                        )}
                      </span>
