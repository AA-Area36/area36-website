...
export default function AboutPage() {
  return (
    <>
      <PageHeader
        title="About Area 36"
        description="Southern Minnesota Area 36 serves as the General Service structure for Alcoholics Anonymous in southern Minnesota, connecting groups to A.A. as a whole."
