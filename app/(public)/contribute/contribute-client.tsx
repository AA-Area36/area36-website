...
export function ContributeClient() {
  ...
  return (
    <>
      <PageHeader
        title="Contribute"
        description="Supporting Area 36 through the Seventh Tradition helps carry the message of Alcoholics Anonymous throughout southern Minnesota."
            ...
            {isAAMember === null ? (
              <Card className="border-primary/20">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardDescription className="text-base">Are you a member of Alcoholics Anonymous?</CardDescription>
                </CardHeader>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <blockquote className="border-l-4 border-primary/50 pl-4 italic text-sm text-muted-foreground">
                    ...
                    much concern those A.A. treasuries which continue, beyond prudent reserves, to accumulate funds for
                    no stated A.A. purpose. Experience has often warned us that nothing can so surely destroy our
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="text-center">
                  <p className="text-sm text-muted-foreground">Or send directly via PayPal app/website to:</p>
                  <p className="text-sm font-medium text-foreground mt-1">treasurer@area36.org</p>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-sm text-muted-foreground mt-6">
              This is a suggested split and may vary based on your group&apos;s conscience. The important thing is that
              your group contributes what it can to support A.A. at all levels.
            </p>
      ...
      <section className="py-12 sm:py-16 bg-primary/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Your contributions help ensure that A.A.&apos;s hand will always be there when the next suffering alcoholic
            reaches out for help. Thank you for supporting Area 36 and the work of Alcoholics Anonymous.
          </p>
        </div>
      </section>
    </>
