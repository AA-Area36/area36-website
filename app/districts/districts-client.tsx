...
export function DistrictsClient({ content }: { content: ContentDoc }) {
  ...
  return (
    <main id="main-content" className="flex-1">
      {/* Hero */}
      <section className="bg-gradient-to-b from-primary/5 to-background py-16 sm:py-20" aria-labelledby="districts-heading">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 id="districts-heading" className="text-4xl font-bold text-foreground sm:text-5xl">
            {t("page.title", "Districts")}
          </h1>
          <p className="mt-4 whitespace-pre-line text-lg text-muted-foreground max-w-3xl">
            {t(
              "page.intro",
